...
import wx,CLWeb,db_program, webbrowser
...
class Frame(wx.Frame):
    def __init__(self, title):
        ...
        self.tbCraigslist = wx.TextCtrl(self.panel, size=(500, -1), pos=(90,20))
    ...
    def Save(self, event):
        ...
        #Clear feilds
        self.tbCraigslist.Clear()
        self.tbEmployer.Clear()
    ...
    def New(self,event):
        webpath = CLWeb.getAddress()
        self.tbCraigslist.SetValue(webpath)
